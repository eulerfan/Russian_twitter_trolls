...
y<-trainSparse[1:8999,"r_nr"]
x<-as.matrix(r_nr~.,data=trainSparse)
...
testSparse$r_nr<-factor(testS$r_nr,levels =c(0,1))
troc2<-prediction(tweet.logit.test,testS$r_nr)
...
#random forest ROC
rfroc<-prediction(predictForest,testS$r_nr)
